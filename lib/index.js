...
exports.main = function main() {
  ...
  const rpc = require('./rpc').default();
  const {render} = require('react-dom');

  // The default zoom was somehow changed with Electron 3 (or maybe 2). Setting
  // zoom factor to 1.2 brings back the normal default size
